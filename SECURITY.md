...
pymascdb is currently pre-1.0 and includes some changes in every release. As such we can't
...
pymascdb allows for unsafe loading of YAML configuration files. Any YAML files
