# MASCDB documentation

MASCDB's documentation is built using the powerful [Sphinx](https://www.sphinx-doc.org/en/master/) framework,
...
The python packages required to build the documentation are listed in the [environment.yaml](https://github.com/ltelab/pymascdb/blob/main/docs/environment.yaml) file.
