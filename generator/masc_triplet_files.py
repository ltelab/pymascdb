...
- The estimation of 3D reconstruction quantities, from Leinonet et al 2021 (https://doi.org/10.5194/amt-14-6851-2021)
  ...
  (https://github.com/jleinonen/masc3dgan), that are running on MASC Proc_data (see first point of this list)
...
To create the proper zarr store at the end, one must run the "./create_zarr_store.py" script .

-----------------------------------------------------------------
HISTORY:

jgr 2024, based on older codes
