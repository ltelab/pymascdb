...
Hi! Thank you for taking the time to contribute to pymascdb.
...
- The `Installation for contributors <https://pymascdb.readthedocs.io/en/latest/installation.html#installation-for-contributors>`__ help you to set up the developing environment and the pre-commit hooks.
- The section `Contributing process <#contributing-process>`__ provides you with a brief overview of the steps that each pymascdb developer must follow to contribute to the repository.
- The `Code review checklist <#code-review-checklist>`__ enable to speed up the code review process.
- The `Code of conduct <https://github.com/ltelab/pymascdb/blob/main/CODE_OF_CONDUCT.md>`__ details the expected behavior of all contributors.
...
You can access and use these templates by visiting the `GitHub Issue Templates page here <https://github.com/ltelab/pymascdb/issues/new/choose>`__.
...
Here is a brief overview of the steps that each pymascdb developer must follow to contribute to the repository.
...
.. image:: https://github.com/ltelab/pymascdb/blob/main/docs/source/static/collaborative_process.png?raw=true
...
Then, please follow the guidelines in the `Installation for contributors <https://pymascdb.readthedocs.io/en/latest/installation.html#installation-for-contributors>`__ section
to create the local copy of the pymascdb repository, set up the developing environment and the pre-commit hooks.

Once you have a local copy of the pymascdb repository on your machine, you're ready to contribute!
...
They are the only ones who accept Pull Requests and push commits directly to the pymascdb repository.
...
The *black* configuration used in the pymascdb project is
defined in the `pyproject.toml <https://github.com/ltelab/pymascdb/blob/main/pyproject.toml>`__.
...
.. image:: https://github.com/ltelab/pymascdb/blob/main/docs/source/static/vs_code_settings.png?raw=true
...
Currently, pymascdb tests that the code to be committed complies with `black's  <https://github.com/psf/black>`__ format style,
...
The versions of the software used in the pre-commit hooks is specified in the `.pre-commit-config.yaml <https://github.com/ltelab/pymascdb/blob/main/.pre-commit-config.yaml>`__ file.
...
| Tool                                               | Aim                                                                                                                               |
+====================================================+===================================================================================================================================+
| `pre-commit.ci <https://pre-commit.ci/>`__         | Run pre-commit (as defined in `.pre-commit-config.yaml <https://github.com/ltelab/pymascdb/blob/main/.pre-commit-config.yaml>`_ ) |
+----------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------+
...
pymascdb tests are written using the third-party `pytest <https://docs.pytest.org>`_ package. Every code change must be tested!

The tests are organized within the ``/pymascdb/tests`` directory and are structured to comprehensively assess various aspects of the code.
...
1. Ensure you have the `development environment <https://pymascdb.readthedocs.io/en/latest/installation.html#installation-for-contributors>`__ correctly set up.
2. Navigate to the pymascdb root directory.
...
.. code-block:: bash
    ...
    pytest pymascdb/tests/<test_subdirectory>/

Run a particular test module:

.. code-block:: bash

    pytest pymascdb/tests/<test_subdirectory>/test_<module_name>.py

These options provide flexibility, allowing you to efficiently target and validate specific components of the pymascdb software.
...
Once your code has been uploaded into your pymascdb fork, you can create a Pull Request (PR) to the pymascdb main branch.
...
-  If adding a new feature:
   ...
   -  Provide a convincing reason to add the new feature. Ideally, propose your idea through a `Feature Request Issue <https://github.com/ltelab/pymascdb/issues/new/choose>`__ and obtain approval before starting work on it. Alternatively, you can present your ideas in the `GitHub Discussions <https://github.com/ltelab/pymascdb/discussions>`__ or in the `pymascdb Slack Workspace <https://join.slack.com/t/pymascdbworkspace/shared_invite/zt-25l4mvgo7-cfBdXalzlWGd4Pt7H~FqoA>`__.
...
Thank you to all the people who have already contributed to pymascdb repository!

If you have contributed data and/or code to pymascdb, add your name to the `AUTHORS.md <https://github.com/ltelab/pymascdb/blob/main/AUTHORS.md>`__ file.
